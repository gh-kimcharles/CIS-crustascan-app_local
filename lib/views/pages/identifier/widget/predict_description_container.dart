...
class PredictDescriptionContainer extends StatelessWidget {
  final String name;
  final String type;
  ...
  const PredictDescriptionContainer({
    required this.name,
    required this.type,
  ...
  Widget build(BuildContext context) {
    final Crustacean species = crustaceanList.firstWhere(
      (speciesItem) => speciesItem.name == name,
      orElse: () {
        throw Exception("Species with id '${name}' not found.");
      },
    );
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => SpeciesDescriptionPage(
                      ...
                      speciesImage: species.imagePath,
                      tag: species.name,
                      type: species.type,
                      ...
                      sampleImage: species.sampleImagePath,
                      imageDescription: species.imageDescription,
                    ),
                  ),
                );
              },
